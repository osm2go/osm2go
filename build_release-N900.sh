...
cmake -D CMAKE_BUILD_TYPE=Release -D CMAKE_TOOLCHAIN_FILE=/opt/scratchbox.cmake -D CMAKE_BUILD_WITH_INSTALL_RPATH=On -D CMAKE_INSTALL_PREFIX=/usr -D BUILD_TESTING=Off .
